...
public class DoTripRecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private Activity activity;
    private List<DiveService> diveServices;

    public DoTripRecyclerViewAdapter(Activity activity) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new DoTripRecyclerViewAdapter.PromoViewHolder(v);
    }
