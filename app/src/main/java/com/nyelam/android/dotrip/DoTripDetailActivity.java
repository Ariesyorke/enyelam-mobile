...
public class DoTripDetailActivity extends AppCompatActivity implements
    DoTripDetailFragment.OnFragmentInteractionListener,
    DoTripReviewFragment.OnFragmentInteractionListener{
        ...
        bookingTextView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (storage.isUserLogin()) {
                    ...
                    Intent intent = new Intent(DoTripDetailActivity.this, AuthActivity.class);
    ...
    private void initRequest() {
        if (diveService != null && !TextUtils.isEmpty(diveService.getId())){
            NYDoDiveDetailServiceRequest req = new NYDoDiveDetailServiceRequest(DoTripDetailActivity.this, diveService.getId(), diver, certificate, schedule);
        ...
        return new RequestListener<DiveService>() {
            ...
            public void onRequestSuccess(DiveService results) {
                ...
                if (results != null){
                    ...
                    if (fragment != null && fragment instanceof DoTripDetailFragment){

                        ((DoTripDetailFragment) fragment).setContent();
    ...
    private RequestListener<CartReturn> onCreateCartServiceRequest() {
        return new RequestListener<CartReturn>() {
            ...
            public void onRequestSuccess(CartReturn cartReturn) {
                ...
                Intent intent = new Intent(DoTripDetailActivity.this, BookingServiceSummaryActivity.class);
    ...
    public class NYFragmentPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            if (position == 0) {
                DoTripDetailFragment fragment = DoTripDetailFragment.newInstance();
                return fragment;
            } else {
                DoTripReviewFragment fragment = DoTripReviewFragment.newInstance();
                return fragment;
            }
        }
