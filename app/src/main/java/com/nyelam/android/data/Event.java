...
public class Event implements Parseable {

    private static String KEY_ID = "id";
    private static String KEY_NAME = "event_name";
    ...
    private static String KEY_NORMAL_PRICE = "start_from_price";
    private static String KEY_SPECIAL_PRICE = "start_from_special_price";
