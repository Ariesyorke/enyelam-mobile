...
public class DoShopProductModule extends DoShopList {
    ...
    public DoShopProductModule(){

    }

    public DoShopProductModule(String id, String productName, String featuredImage, List<String> images, String specialPrice
