...
public class DiveSpotMapFragment extends Fragment implements OnMapReadyCallback {
    ...
    public DiveSpotMapFragment() {
        // Required empty public constructor
    }

    // TODO: Rename and change types and number of parameters
    public static DiveSpotMapFragment newInstance() {
        DiveSpotMapFragment fragment = new DiveSpotMapFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_dive_spot_map, container, false);
    }
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        if (diveSpot != null){
            ...
            if (diveSpot.getLocation() != null && diveSpot.getLocation().getCoordinate() != null){
                double lat = diveSpot.getLocation().getCoordinate().getLat();
                double lon = diveSpot.getLocation().getCoordinate().getLon();
            ...
            if (NYHelper.isStringNotEmpty(diveSpot.getName())) name = diveSpot.getName();
            if (diveSpot.getLocation() != null){
                Location loc = diveSpot.getLocation();
