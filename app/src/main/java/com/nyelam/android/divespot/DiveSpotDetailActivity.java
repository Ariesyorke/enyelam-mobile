...
public class DiveSpotDetailActivity extends AppCompatActivity implements
    ...
    private RequestListener<DiveSpot> onGetDetailDiveSpotRequest() {
        return new RequestListener<DiveSpot>() {
            @Override
            public void onRequestFailure(SpiceException spiceException) {
                /*if (progressBar != null) {
                    progressBar.setVisibility(View.GONE);
                }*/
                NYHelper.handleAPIException(DiveSpotDetailActivity.this, spiceException, null);
            }

            @Override
            public void onRequestSuccess(DiveSpot results) {
                if (diveService == null) diveSpot = new DiveSpot();
                diveSpot = results;
