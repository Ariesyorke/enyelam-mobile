...
public class NYDoDiveSearchDiveCenterRequest extends NYBasicRequest<DiveCenterList> {
    ...
    public NYDoDiveSearchDiveCenterRequest(Context context, String apiPath, String page, String diverId, String type, String certificate, String diver, String date, String sortBy, List<String> categories, String ecoTrip) {
