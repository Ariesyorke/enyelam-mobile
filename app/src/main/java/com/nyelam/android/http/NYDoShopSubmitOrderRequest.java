...
public class NYDoShopSubmitOrderRequest extends NYBasicAuthRequest<DoShopOrder> {
    ...
    private final static String POST_DELIVERY_SERVICE_ID = "delivery_service_id";
    private final static String POST_TYPE_ID = "type_id";
    private final static String POST_VOUCHER_CODE = "voucher_code";

    public NYDoShopSubmitOrderRequest(Context context, String paymentMethodId, String cartToken, String billingAddressId, String shippingAddressId, String deliveryServiceId, String typeId, String voucherCode) throws Exception {
        ...
        if(!TextUtils.isEmpty(deliveryServiceId)) {
            addQuery(POST_DELIVERY_SERVICE_ID, deliveryServiceId);
        }
