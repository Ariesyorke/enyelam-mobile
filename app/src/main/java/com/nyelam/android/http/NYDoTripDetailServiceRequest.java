...
public class NYDoTripDetailServiceRequest extends NYBasicRequest<DiveService> {
    ...
    public NYDoTripDetailServiceRequest(Context context, String serviceId, String diver, String certificate, String date) {
        super(AuthReturn.class, context, context.getResources().getString(R.string.api_path_dotrip_detail_service));
