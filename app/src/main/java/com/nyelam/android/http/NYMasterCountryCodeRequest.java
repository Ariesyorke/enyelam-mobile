...
public class NYMasterCountryCodeRequest extends NYBasicRequest<NYPaginationResult<CountryCodeList>> {
    ...
    public NYMasterCountryCodeRequest(Context context, String page) {
