...
/**
 * Created by Aprilian Nur Wakhid Daini on 3/28/2018.
 */

public class RecyclerViewTouchListener  implements RecyclerView.OnItemTouchListener {
    private GestureDetector gestureDetector;
    private DoDiveDiveServiceSuggestionAdapter.RecyclerViewClickListener recyclerViewClickListener;

    public RecyclerViewTouchListener(Context context, final RecyclerView recyclerView, final DoDiveDiveServiceSuggestionAdapter.RecyclerViewClickListener recyclerViewClickListener1) {
