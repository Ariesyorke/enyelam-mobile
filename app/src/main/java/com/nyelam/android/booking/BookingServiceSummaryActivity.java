...
public class BookingServiceSummaryActivity extends BasicActivity implements NYCustomDialog.OnDialogFragmentClickListener, TransactionFinishedCallback {
    ...
    private void testVeritrans() {
        ...
        UserDetail userDetail = LocalDataHandler.readObject("user_detail", UserDetail.class);
        if (userDetail == null) {
        ...
        TransactionRequest transactionRequest = new TransactionRequest("1111222", 600000);
        ...
        BillInfoModel billInfoModel = new BillInfoModel("mykey", "myvalue");
