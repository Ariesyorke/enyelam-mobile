...
public class BookingHistoryCompletedFragment extends Fragment {
    ...
    public static BookingHistoryCompletedFragment newInstance(String param1, String param2) {
        BookingHistoryCompletedFragment fragment = new BookingHistoryCompletedFragment();
